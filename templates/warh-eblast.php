    ...
    <div id="content" role="main">
        ...
        <?php if( have_posts() ) : ?>
            <?php while( have_posts() ) : the_post(); ?>
                <?php $core_items = json_decode( get_post_meta( get_the_ID(), 'core_items', TRUE) ); ?>
    ...
    <tr>
        <td width="100%" bgcolor="#e2e2e2">
            <table cellpadding="0" border="0" cellspacing="0" align="center">
                <tr>
                    <td rowspan="2"><img src="http://media.dev-cms.com/stl/5/531/53199.jpg" alt="" /></td>
                    <td colspan="5"><img src="http://media.dev-cms.com/stl/5/531/53192.jpg" alt="" /></td>
                    <td rowspan="2"><img src="http://media.dev-cms.com/stl/5/532/53200.jpg" alt="" /></td>
                    
                </tr>
                <tr>
                    <td><img src="http://media.dev-cms.com/stl/5/531/53193.jpg" alt="" /></td>
                    <td><a href="http://www.1065thearch.com/concerts-shows/"><img src="http://media.dev-cms.com/stl/5/532/53201.jpg" alt="" /></a></td>
                    <td><a href="http://www.1065thearch.com/events/"><img src="http://media.dev-cms.com/stl/5/531/53196.jpg" alt="" /></a></td>
                    <td><a href="http://allies.1065thearch.com/asp3/contests.aspx"><img src="http://media.dev-cms.com/stl/5/531/53197.jpg" alt="" /></a></td>
                    <td><a href="http://allies.1065thearch.com/"><img src="http://media.dev-cms.com/stl/5/531/53198.jpg" alt="" /></a></td>
                </tr>
            </table>
        </td>
    </tr>
...
foreach( $core_items as $item_id => $item ) : ?>
